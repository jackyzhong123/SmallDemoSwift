...
class ProfileVC: GlobalVC ,UITableViewDelegate,UITableViewDataSource ,UIImagePickerControllerDelegate,UINavigationControllerDelegate{
    ...
    override func RenderDetail()
    {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: Selector("changeUserStatus:"), name: AppConfig.ConstNotification.ChangeUerProfile, object: nil)
    }
    ...
    override func requestDataComplete(response:AnyObject,tag:Int)
    {
        if (tag == 98)
        {
            ...
            AppConfig.sharedAppConfig.Portrait = responseJson.objectForKey("Portrait") as! String
            AppConfig.sharedAppConfig.save()
            tableView.reloadData()
            NSNotificationCenter.defaultCenter().postNotificationName(AppConfig.ConstNotification.ChangeUerProfile, object: nil, userInfo: nil)
        ...
        {
            SVProgressHUD.dismiss()
            let parameter = ["image": response as! String ]
            self.httpPostApi(AppConfig.ConstUrl.changeUserPortrait, body: parameter, tag: 98)
            return
        }
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        }else if (indexPath.section == 1)
        {
            ...
            let photoItem:NSDictionary! = CellArray1[index] as NSDictionary
            
            
            
            let vc:UIViewController  = UIHelper.GetVCWithIDFromStoryBoard(.Account, viewControllerIdentity: photoItem["targetVC"] as! String)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        {
            let cell:MeHeaderCell =  tableView.dequeueReusableCellWithIdentifier(headCell) as! MeHeaderCell
            ...
            cell.lbName.text = "头像"
            let layer:CALayer = cell.imgCover.layer
        ...
        } else if (indexPath.section == 1)
        {
            ...
            let cell:UITableViewCell =  tableView.dequeueReusableCellWithIdentifier(generalCell)!
            
            let photoItem:NSDictionary! = CellArray1[indexPath.row] as NSDictionary
        ...
        {
            let cell:UITableViewCell =  tableView.dequeueReusableCellWithIdentifier(logoutCell)!
            ...
            let v = UIView(frame: CGRectMake(0, 0, UIScreen.mainScreen().bounds.size.width, cell.frame.height));
            let label = UILabel(frame: v.frame);
...
//            }
    ...
    func imgHeadChange()
    {
        let alertController = UIAlertController(title: "修改图像", message: "", preferredStyle: UIAlertControllerStyle.ActionSheet)
    ...
    func imagePickerController(picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
        ...
        picker.dismissViewControllerAnimated(true, completion: {
            ...
            if(gotImage != nil)
            {
                ...
                let imgData =  UIImageJPEGRepresentation(gotImage, 1.0)
